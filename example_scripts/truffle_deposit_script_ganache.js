...
async function run_deposit(){
    ...
    let to_deposit = await erc20_token_instance.balanceOf(wallet_address);
    console.log("VUSD Balance After Faucet: " + to_deposit);
    ...
    try{
        await erc20_bridge_instance.list_asset_admin(erc20_token_contract.address, 0, "0x11e09c9e87849d7c2d9df126a9057f3b0ebb94e107dfb73f9451854efeeb27dd", {from: wallet_address});
    } catch (e) {

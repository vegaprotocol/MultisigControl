---
id: version-undefined-ERC20_Bridge_Logic_Restricted
title: ERC20_Bridge_Logic_Restricted
original_id: ERC20_Bridge_Logic_Restricted
---

# ERC20 Bridge Logic (ERC20_Bridge_Logic_Restricted.sol)

View Source: [contracts/ERC20_Bridge_Logic_Restricted.sol](../contracts/ERC20_Bridge_Logic_Restricted.sol)

**↗ Extends: [IERC20_Bridge_Logic_Restricted](IERC20_Bridge_Logic_Restricted.md)**
...
- [(address payable erc20_asset_pool)](#erc20_bridge_logic_restrictedsol)
- [multisig_control_address()](#multisig_control_address)
- [list_asset(address asset_source, bytes32 vega_asset_id, uint256 lifetime_limit, uint256 withdraw_threshold, uint256 nonce, bytes signatures)](#list_asset)
- [remove_asset(address asset_source, uint256 nonce, bytes signatures)](#remove_asset)
- [set_asset_limits(address asset_source, uint256 lifetime_limit, uint256 threshold, uint256 nonce, bytes signatures)](#set_asset_limits)
- [get_asset_deposit_lifetime_limit(address asset_source)](#get_asset_deposit_lifetime_limit)
- [get_withdraw_threshold(address asset_source)](#get_withdraw_threshold)
- [set_withdraw_delay(uint256 delay, uint256 nonce, bytes signatures)](#set_withdraw_delay)
- [global_stop(uint256 nonce, bytes signatures)](#global_stop)
- [global_resume(uint256 nonce, bytes signatures)](#global_resume)
- [exempt_depositor()](#exempt_depositor)
- [revoke_exempt_depositor()](#revoke_exempt_depositor)
- [is_exempt_depositor(address depositor)](#is_exempt_depositor)
- [withdraw_asset(address asset_source, uint256 amount, address target, uint256 creation, uint256 nonce, bytes signatures)](#withdraw_asset)

---
id: version-undefined-IMultisigControl
...
View Source: [contracts/IMultisigControl.sol](../contracts/IMultisigControl.sol)

**↘ Derived Contracts: [MultisigControl](MultisigControl.md)**
...
- [set_threshold(uint16 new_threshold, uint256 nonce, bytes signatures)](#set_threshold)
- [add_signer(address new_signer, uint256 nonce, bytes signatures)](#add_signer)
- [remove_signer(address old_signer, uint256 nonce, bytes signatures)](#remove_signer)
- [verify_signatures(bytes signatures, bytes message, uint256 nonce)](#verify_signatures)
- [get_valid_signer_count()](#get_valid_signer_count)
- [get_current_threshold()](#get_current_threshold)
- [is_valid_signer(address signer_address)](#is_valid_signer)
- [is_nonce_used(uint256 nonce)](#is_nonce_used)
